...
const documentos = await incorporarDocumentos([ 'Reciclar é mais do que uma simples ação; é um compromisso consciente com a preservação do meio ambiente, um passo decisivo em direção a um futuro sustentável para as próximas gerações.',
    'O planeta Terra é o nosso lar comum, e cuidar dele não é uma opção, mas sim uma responsabilidade coletiva que define o nosso legado para as gerações futuras'
 ]);
